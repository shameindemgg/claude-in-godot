...
**$25 one-time purchase**, or **$54 bundle with eyehands** (save $20) — [fireal.dev/godot-catalyst/#buy](https://fireal.dev/godot-catalyst/#buy)
...
The MCP server is proprietary — see [LICENSE](LICENSE). Purchase at [fireal.dev/godot-catalyst/#buy](https://fireal.dev/godot-catalyst/#buy).
